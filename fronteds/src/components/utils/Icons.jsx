...
export const users = <i className="bi bi-people-fill"></i>
export const dollar = <i className="fa fa-rupee" ></i>
export const calender = <i className="bi bi-calendar-check-fill"></i>
export const comment = <i className="bi bi-chat-right-dots-fill"></i>
export const plus = <i className="fa-solid fa-plus"></i>
export const trash = <i className="bi bi-trash"></i>
...
export const uber = <i className="bi bi-bicycle"></i>
